...
public class DairyProductsService {
	...
	public String updatedairyProducts(long id, String productsName, String quantity, Double price, MultipartFile file)  throws IOException, SerialException, SQLException{

...
public class VegetablesService {
	...
	public String updatevegetables(long id, String vegetablesName, String quantity, Double price, MultipartFile file) throws IOException, SerialException, SQLException {
